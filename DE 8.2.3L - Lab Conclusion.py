...
fp="dbfs:/user/lonma@deloitte.com/dbacademy/dewd/dlt_lab_82/storage/system/events"
files = dbutils.fs.ls(fp)
display(files)
spark.conf.set('v.fp','dbfs:/user/lonma@deloitte.com/dbacademy/dewd/dlt_lab_82/storage/system/events')

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from delta.`${v.fp}`
